...
class whatIsOrganDonationPage extends StatelessWidget {
  const whatIsOrganDonationPage({super.key, required String type});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        leadingWidth: 40,      // 👈 reduce space for back button
        titleSpacing: 0,       // 👈 remove gap between icon & title
